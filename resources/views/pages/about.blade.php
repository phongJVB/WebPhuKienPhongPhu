		...
		<div class="container">
			...
			<div class="pull-right">
				<div class="beta-breadcrumb font-large">
					<a href="{{ Route('home.index') }}">Home</a> / <span>Giới thiệu</span>
				</div>
			</div>
		...
		<div id="content">
			<div class="our-history">
				...
				<div class="history-slider">
					<div class="history-navigation">
						...
						<a data-slide-index="3" href="blog_with_2sidebars_type_e.html" class="circle"><span class="auto-center">2006</span></a>
						<a data-slide-index="4" href="blog_with_2sidebars_type_e.html" class="circle"><span class="auto-center">2007</span></a>
						<a data-slide-index="5" href="blog_with_2sidebars_type_e.html" class="circle"><span class="auto-center">2008</span></a>
						<a data-slide-index="6" href="blog_with_2sidebars_type_e.html" class="circle"><span class="auto-center">2009</span></a>
					</div>
					...
					<div class="history-slides">
						<div> 
							<div class="row">
							<div class="col-sm-5">
								<img src="frontEnd/assets/dest/images/history.jpg" alt="">
							</div>
							<div class="col-sm-7">
			...
			<div class="row">
				<div class="col-sm-6 wow fadeInLeft">
					<div class="beta-person media">
						...
						<img class="pull-left" src="frontEnd/assets/dest/images/person2.jpg" alt="">
				...
				<div class="col-sm-6 wow fadeInRight">
					<div class="beta-person media ">
						...
						<img class="pull-left" src="frontEnd/assets/dest/images/person3.jpg" alt="">
			...
			<div class="row">
				...
				<div class="bets-img-hover">
						<img src="frontEnd/assets/dest/images/person1.jpg" alt="">
				</div>
				...
				<div class="col-sm-3">
					<div class="beta-person beta-person-full">
					<div class="bets-img-hover">
						<img src="frontEnd/assets/dest/images/person2.jpg" alt="">
					</div>
						<div class="beta-person-body">
							<h5>Bob Robertson</h5>
							<p class="font-large">Web developer</p>
				...
				<div class="col-sm-3">
					<div class="beta-person beta-person-full">
					<div class="bets-img-hover">
						<img src="frontEnd/assets/dest/images/person3.jpg" alt="">
					</div>
						<div class="beta-person-body">
							<h5>Mike Greenwood</h5>
							<p class="font-large">Web developer</p>
				...
				<div class="col-sm-3">
					<div class="beta-person beta-person-full">
					<div class="bets-img-hover">	
						<img src="frontEnd/assets/dest/images/person4.jpg" alt="">
					</div>
						<div class="beta-person-body">
							<h5>David Black</h5>
							<p class="font-large">Web developer</p>
